...
Net::Request GetProductsForPeriodicProductModel::FormRequest(IdType periodic_product_id)
{
	Net::Request request;
	request.uri = m_hostname + "/periodic-products/" + std::to_string(periodic_product_id) + "/products";
