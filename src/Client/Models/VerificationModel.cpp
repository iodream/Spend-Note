...
Net::Request VerificationModel::FormRequest(const VerificationInDTO& dto)
{
	Net::Request request;
...
QJsonDocument VerificationModel::JSONFormatter::Format(const VerificationInDTO& dto)
{
	QJsonObject json;
...
bool VerificationModel::CheckData(const VerificationInDTO& dto) const
{
